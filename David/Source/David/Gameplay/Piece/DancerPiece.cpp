...
void ADancerPiece::SetupPiece(ABoardManager* BoardManagerActor, const FGameCardData& GameCardData, FCardData& InCardData, int32 ID, EDavidPlayer PieceOwner)
{
	Super::SetupPiece(BoardManagerActor, GameCardData, InCardData, ID, PieceOwner);
